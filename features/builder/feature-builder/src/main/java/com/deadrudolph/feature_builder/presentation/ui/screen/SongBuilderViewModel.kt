...
internal abstract class SongBuilderViewModel : ViewModel() {
    ...
    abstract val textFieldsStateFlow: StateFlow<List<TextFieldValue>>

    abstract val chordsListStateFlow: StateFlow<List<Chord>>

    abstract val chordPickerStateFlow: StateFlow<Boolean>

    abstract val focusedTextFieldIndex: StateFlow<Int>
    ...
    abstract val testTextField: MutableStateFlow<TextFieldValue>
}