...
class TextLayoutInput private constructor(
     ...
     * [NewTextLayoutResult.placeholderRects] that corresponds to this input.
     *
     * @see NewTextLayoutResult.placeholderRects
     * @see MultiParagraph
 ...
 */
class NewTextLayoutResult constructor(
    /**
     ...
     * [NewTextLayoutResult.placeholderRects] will have same length and order.
     *
    ...
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is NewTextLayoutResult) return false
