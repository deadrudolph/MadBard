 ...
 */
/*@VisibleForTesting*/
internal object SemanticsActions {
    /**
     * @see SemanticsPropertyReceiver.getTextLayoutResult
     */
    val GetTextLayoutResult =
        ActionPropertyKey<(MutableList<NewTextLayoutResult>) -> Boolean>("GetTextLayoutResult")
...
/**
 * Action to get a Text/TextField node's [NewTextLayoutResult]. The result is the first element
