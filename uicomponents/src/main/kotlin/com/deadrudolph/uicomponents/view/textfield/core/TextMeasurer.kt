...
import com.deadrudolph.uicomponents.view.textfield.extension.ceilToInt
...
class TextMeasurer constructor(
    ...
    private val cacheSize: Int = com.deadrudolph.uicomponents.view.textfield.core.constants.DefaultCacheSize
) {
 ...
 */
internal class TextLayoutCache(capacity: Int = com.deadrudolph.uicomponents.view.textfield.core.constants.DefaultCacheSize) {
